...
export class PortfolioDataService {
  ...
  private readonly livePortfolio$ = forkJoin({
  ...
  private getUserData(): Observable<GitHubUser> {
    return this.user$;
  }

  private getRepositories(): Observable<GitHubRepositoryApi[]> {
    return this.repositories$;
  }

  private getLanguages(repository: string, owner = this.username): Observable<Record<string, number>> {
